...
class Bundle extends Component {
    ...
    checkAuth(href){
        ...
        if(href==="/authority/home/pageNoAuth"){//无权限的页面的显示
            return true;
        }
        if(href==="/authority/login"){//跳登录时，清空USERAUTH
            window.USERAUTH = undefined;
            return true;
        }
    ...
    async componentDidMount() {
        ...
        if (window.USERAUTH) {
            ...
            if(!this.checkAuth(router.location.pathname)){
                window.location.href = '/authority/home/pageNoAuth'
            }
        }
